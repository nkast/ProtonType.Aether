...
namespace tainicom.ProtonType.XnaContentPipeline.ViewModels
{
    public partial class PipelineItemViewModel
    {
        ...
        class ProcessorPropertyDescriptor : PropertyDescriptor
        {
            private PropertyDescriptor _property;
            private TypeConverter _converter;
            
            public ProcessorPropertyDescriptor(PropertyDescriptor property, TypeConverter processorTypeConverter) : base(property)
            {
                this._property = property;
                this._converter = processorTypeConverter;
            }
