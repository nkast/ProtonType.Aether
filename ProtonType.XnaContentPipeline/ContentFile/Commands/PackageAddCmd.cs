...
{
    internal class PackageAddCmd : CommandBase
    {
        private PackageViewModel _item;
        private int _prevIndex;
        
        public PackageAddCmd(PackagesViewModel receiver, PackageViewModel item) : base(receiver)
        {
            this._item = item;
        }
